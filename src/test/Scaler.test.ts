...
describe("Scaler", () => {
    ...
    describe("constructor", () => {
        it("throws error when width is invalid", () => {
            assertThrowWithMessage(() => new Scaler(-1, 1, 2), RangeError, "Source width must be 0-8192 but is -1");
            assertThrowWithMessage(() => new Scaler(10001, 1, 2), RangeError, "Source width must be 0-8192 but is 10001");
            assertThrowWithMessage(() => new Scaler(NaN, 1, 2), RangeError, "Source width must be 0-8192 but is NaN");
        });
        it("throws error when height is invalid", () => {
            assertThrowWithMessage(() => new Scaler(1, -1, 2), RangeError, "Source height must be 0-8192 but is -1");
            assertThrowWithMessage(() => new Scaler(1, 10001, 2), RangeError, "Source height must be 0-8192 but is 10001");
            assertThrowWithMessage(() => new Scaler(1, NaN, 2), RangeError, "Source height must be 0-8192 but is NaN");
        });
    ...
    describe("scale", () => {
        ...
        it("keeps different scaler instances isolated", async () => {
            const scaler1 = new Scaler(sample1.width, sample1.height, 2);
            const scaler2 = new Scaler(sample2.width, sample2.height, 2);
